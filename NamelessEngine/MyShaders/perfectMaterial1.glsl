...
void main(){
	...
	vec4 albedoMap = vec4(1,1,1,1);			//0.0 Black. --> 1.0 rgb colored.
	float roughnessMap = 1.0;				//0.1 Polished.  --> 1.0 Rough.
	float metalnessMap = 0.0;				//0.0 Dielectric. --> 0.5 Semiconductor. -->  1.0 Metalic
